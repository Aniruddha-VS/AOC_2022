...
for instruction in instructions:
    ...
    collection_of_stacks[to_where] = collection_of_stacks[to_where] + collection_of_stacks[from_where][-how_many:]
    collection_of_stacks[from_where] = collection_of_stacks[from_where][:-how_many]
